...
def run(rank, n_gpus, hps):
  ...
  dist.init_process_group(backend='nccl', init_method='env://', world_size=n_gpus, rank=rank)   # Linux Only
...
def evaluate(hps, generator, eval_loader, writer_eval):
    ...
    with torch.no_grad():
      for batch_idx, (x, x_lengths, spec, spec_lengths, y, y_lengths) in enumerate(eval_loader):
        ...
        break
      y_hat, y_hat_mb, attn, mask, *_ = generator.module.infer(x, x_lengths, max_len=1000) # Linux
